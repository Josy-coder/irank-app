...
export default defineSchema({
  ...
  judging_scores: defineTable({
    ...
    speaker_scores: v.array(v.object({
      ...
      content_knowledge: v.optional(v.number()),
      argumentation_logic: v.optional(v.number()),
      presentation_style: v.optional(v.number()),
      teamwork_strategy: v.optional(v.number()),
      rebuttal_response: v.optional(v.number()),
